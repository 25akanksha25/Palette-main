...
import { addBidOnItem,getWinnerOfAuction, getBidsByUser,getAllBidsByAuctionId, deleteBid } from "../controllers/bid.controller.js";
...
router.route("/:auctionId/delete/:deletedUserId").delete(verifyUser, deleteBid);
