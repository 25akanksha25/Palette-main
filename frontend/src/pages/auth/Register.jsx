...
const Register = () => {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-white text-black">
      <div className="flex w-[90%]  flex-col items-center justify-center rounded-xl bg-gray-300 py-8 sm:w-2/5 sm:px-6">
        ...
        >
          ...
          <div className=" pr-3 overflow-hidden flex justify-between items-center w-full rounded bg-gray-300 outline-none mb-4  ">
            <input
              ...
              className=" w-full pl-5 py-3 bg-gray-200 text-black placeholder-gray-500r outline-none border border-border-info-color"
              name="password"
