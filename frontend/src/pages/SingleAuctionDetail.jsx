...
//   //   setSingleAuctionData((prevState) => ({
//   //     ...prevState,
//   //     startingPrice: data.bidAmount, // Ensure the highest bid is updated
//   //     bids: [{ bidAmount: data.bidAmount }, ...prevState?.bids || []], // Keep bids updated
//   //   }));
//   // });
...
//         ...prevState,
//         startingPrice: data.bidAmount, 
//         bids: [{ bidAmount: data.bidAmount }, ...prevState?.bids || []], 
//       }));
//     };
  
//     socket.on("newBidData", handleNewBid);
  
//     return () => {
//       socket.off("newBidData", handleNewBid); // Clean up to avoid duplicate listeners
//     };
//   }, []);
...
//           alt="product image"
//         />
//         <div className="w-full flex gap-4 flex-col p-4 border-2 border-gray-300 rounded">
//           <div>
//             <h2 className="text-3xl font-extrabold text-black">
//               {singleAuction?.name}
//             </h2>

//             <div className="pt-4 flex flex-row gap-4 flex-wrap text-black capitalize">
//               <a
//                 href="#"
...
//               <div id="author-item" className="text-black">
...
//                 <p className="text-gray-700">
//   ₹{bidsData.length > 0 
//     ? bidsData[0].bidAmount  // Show latest bid
//     : singleAuctionData?.startingPrice}
// </p>
//               </div>
