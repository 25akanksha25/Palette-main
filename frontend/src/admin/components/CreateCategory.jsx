  ...
  return (
    <div>
      ...
      >
          ...
          {imgUrl ? (
            ...
            <div
              ...
              rounded-xl border-2 border-dashed border-border-info-color 
                    ...
                    "
            >
              <div className="text-black text-center flex flex-col items-center gap-2">
                <IoCloudUploadOutline size={68} className="text-black" />
                <p>Click to Upload</p>
        ...
        {/* INPUTS */}
        <div className="flex flex-col gap-4 bg-gray-300 lg:w-[50%] inputs:outline-none p-8 inputs:px-4 inputs:py-3 inputs:rounded-xl select:px-4 select:py-3 select:rounded-xl select:cursor-pointer border border-gray-700 inputs:bg-gray-100 inputs:border inputs:border-gray-700 focus:inputs:border-gray-700 select:border select:border-gray-700 inputs:placeholder-body-text-color text-slate-300 rounded-2xl [&_label]:mb-2 [&_label]:text-black [&_*]:transition-all">
          <div className="grid">
          ...
          <div className="grid">
            ...
            <textarea
              ...
              id="description"
              rows="7"
              className="outline-none bg-gray-100 rounded-xl px-3 py-4 border border-gray-700 focus:border-gray-700 placeholder-body-text-color"
              onChange={(e) =>
          ...
          <button
            type="submit"
            className="px-3 py-4 rounded-xl text-white cursor-pointer font-bold tracking-wide w-full bg-black hover:bg-gray-100 hover:text-black border border-black"
          >
            Upload
          </button>
        </div>
