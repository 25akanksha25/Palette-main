    ...
    <div className="w-full h-full lg:w-[25%] sm:min-w-[250px] lg:max-w-[250px]    ">
      <div className="text-white bg-theme-bg p-5  ">
        <ul className="flex flex-col gap-1 font-medium">
          ...
          <li>             
          <Link className={`flex items-center gap-2 py-2 px-4 rounded-lg cursor-pointer hover:pl-[20px] hover:text-theme-color hover:bg-theme transition-all duration-500` 
              // ${
