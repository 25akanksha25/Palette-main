  ...
  return (
    <div>
      ...
      >
        ...
        <div className="flex flex-col bg-gray-300 gap-4 lg:w-[80%] inputs:outline-none p-8 inputs:px-4 inputs:py-3 inputs:rounded-xl select:px-4 select:py-3 select:rounded-xl select:cursor-pointer border border-gray-700 inputs:bg-gray-100 inputs:border inputs:border-gray-700 focus:inputs:border-gray-700 select:border select:border-gray-700 inputs:placeholder-body-text-color text-gray-700 rounded-2xl [&_label]:mb-2 [&_label]:text-black [&_*]:transition-all">
          <div className="grid">
          ...
          <div className="grid">
            ...
            <textarea
              ...
              id="description"
              rows="7"
              className="outline-none bg-gray-100 rounded-xl px-3 py-4 border border-gray-700 focus:border-gray-700 placeholder-text-gray-600"
              onChange={(e) =>
