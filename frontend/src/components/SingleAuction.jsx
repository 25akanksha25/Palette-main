...
const SingleAuction = ({
  ...
  return (
    <div className=" h-full justify-between bg-gray-100 border-2 border-gray-400 rounded-lg flex flex-col p-3  text-white  ">
      <div>
        <div className="w-full rounded-md relative bg-gray-300 overflow-hidden ">
          <img
            ...
            alt="item image"
          />
          <div className="absolute left-1 bottom-3 right-3 border-[0.5px] border-white border-solid rounded-full py-1 px-3 text-sm bg-gray-950 bg-opacity-[0.8] ">
            <CountDownTimer
              startTime={startTime}
              endTime={endTime}
              status={status}
        ...
        <h3 className="my-3 text-[19px] font-Barlow text-black ">{name}</h3>
      </div>
      <div>
        <div className="flex justify-start items-center">
          ...
          <div className="ml-3">
            <h3 className="text-sm text-black">{sellerName}</h3>
          </div>
        </div>
