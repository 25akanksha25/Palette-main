...
const Notifications = () => {
  ...
  return (
    <div className="overflow-auto flex flex-col w-full px-7 py-4 bg-gray-300 text-body-text-color border border-gray-600 rounded-2xl ">
      ...
      <button
        className="flex items-center gap-2 rounded-xl px-4 py-3 text-white cursor-pointer font-bold tracking-wide w-fit bg-black hover:bg-gray-400 hover:text-black transition-all"
      ...
      {//max-h-[750px]
        ...
        {currentNotifications?.map((notification) => (
          <Link
            ...
            className={` text-white p-5 rounded-2xl border border-border-info-color [&_span]:text-white hover:border-black transition-all ${
        ...
        <div className="flex items-center justify-center h-[500px]">
          <h1 className="text-black">No Notifications</h1>
        </div> }
